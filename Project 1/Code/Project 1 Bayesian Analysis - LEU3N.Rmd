...
#credible interval
ci(draws_df_LEU3N[[beta_name]], ci = 0.95)


```

The posterior mean difference in CD4 count between hard drug users and non-users was negative, with a 95% credible interval from −221.9 to −100.2 cells. The posterior probability that the magnitude of the difference exceeds 50 cells was 99.97%, indicating very strong evidence of a clinically meaningful reduction in CD4 count among hard drug users.
...
#credible interval
ci(draws_df_LEU3N_ADH[[beta_name]], ci = 0.95)
```

After adjusting for adherence level, the posterior mean difference in CD4 count between hard drug users and non-users was negative, with a 95% credible interval from −228.4 to −107.2 cells. The posterior probability that the magnitude of the difference exceeds 50 cells was 99.99%, indicating extremely strong evidence that hard drug use is associated with a clinically meaningful decrease in CD4 count, conditional on adherence.
