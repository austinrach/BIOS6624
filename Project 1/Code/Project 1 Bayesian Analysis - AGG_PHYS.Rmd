...
#credible interval
ci(draws_df_AGG_PHYS[[beta_name]], ci = 0.95)
```
The posterior mean difference in AGG_PHYS score between hard drug users and non-users was negative, with a 95% credible interval from −5.59 to −0.29. The posterior probability that the magnitude of the difference exceeds 2 points was 75.9%, indicating moderate evidence for a clinically meaningful reduction in AGG_PHYS score among hard drug users. There remains approximately 24% posterior probability that the true difference is smaller than the clinically meaningful threshold.
...
#credible interval
ci(draws_df_AGG_PHYS_ADH[[beta_name]], ci = 0.95)
```
After adjusting for adherence level, the posterior mean difference in AGG_PHYS score between hard drug users and non-users was negative, with a 95% credible interval from −5.89 to −0.56. The posterior probability that the magnitude of the difference exceeds 2 points was 82.0%, indicating moderate evidence for a clinically meaningful reduction in AGG_PHYS score among hard drug users. There remains approximately 18% posterior probability that the true difference is smaller than the clinically meaningful threshold.
