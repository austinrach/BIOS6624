...
```
There is a 27.03% posterior probability that hard drug use is associated with at least a 0.5 log-unit difference in viral load. There is little evidence of a meaningful effect after adjusting for adherence.
