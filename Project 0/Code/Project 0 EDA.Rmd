...
Think about how to account for days!!!!!!!!!
...
Scatter plot of cap time between waking up and booklet time since waking up (continuous)
...
One sample t.test comparing sampling and electric monitoring cap, Pearsons correlation, Mixed model - let's do mixed model and use ICC to capture agreement 
pivot to long then implement the model with random component for subject and maybe sample (check conevrgence)
...
Descriptive statistics okay maybe try 
...
1. create var that is 30 min from waking and 10 
2. create diff variable

Descriptive stats then a logistic regression analysis? with random subj component

Question 3:
Spaghetti plot to determine patterns
Piecewise linear regression - maybe knots at 30 mins, 1 hr  ? less interested in significance, more interested in magnitude

Booklet time or cap time - choose whichever you think is best froma. statistical point of view
