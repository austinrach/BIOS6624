...
EDA:
```{r}
# Carry Sleep.Diary.reported.wake.time down by subject by date 

# Carry Booklet Sample Interval over with 0s
...
# Fill in any missing NA variables
plot(df$Booket..Clock.Time, df$MEMs..Clock.Time)
```
